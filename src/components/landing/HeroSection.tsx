    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 animate-[fadeUp_1.2s_ease-out]">
          <a href="/login" className="bg-[#4318FF] text-white font-bold px-8 py-4 rounded-2xl text-lg hover:bg-[#3311db] shadow-xl shadow-[#4318FF]/25 hover:shadow-[#4318FF]/40 transition-all hover:-translate-y-1 hover:scale-105">
            Start for Free
          </a>
